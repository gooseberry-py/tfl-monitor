...
class SequenceRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /{ids-id}/Route/Sequence
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/{ids%2Did}/Route/Sequence", path_parameters)
    
    def by_direction(self,direction: str) -> WithDirectionItemRequestBuilder:
        """
        Gets an item from the tfl_api_line.item.Route.Sequence.item collection
