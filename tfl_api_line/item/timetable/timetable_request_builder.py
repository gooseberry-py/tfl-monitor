...
class TimetableRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /{ids-id}/Timetable
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/{ids%2Did}/Timetable", path_parameters)
    
    def by_from_stop_point_id(self,from_stop_point_id: str) -> WithFromStopPointItemRequestBuilder:
        """
        Gets an item from the tfl_api_line.item.Timetable.item collection
