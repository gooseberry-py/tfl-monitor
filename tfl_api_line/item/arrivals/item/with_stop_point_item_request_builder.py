...
class WithStopPointItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /{ids-id}/Arrivals/{stopPointId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/{ids%2Did}/Arrivals/{stopPointId}{?destinationStationId*,direction*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[WithStopPointItemRequestBuilderGetQueryParameters]] = None) -> Optional[list[Tfl41]]:
        """
