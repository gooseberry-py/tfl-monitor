...
class StatusRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Mode/{modes}/Status
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Mode/{modes}/Status{?detail*,severityLevel*}", path_parameters)
    ...
    class StatusRequestBuilderGetQueryParameters():
        ...
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "severity_level":
