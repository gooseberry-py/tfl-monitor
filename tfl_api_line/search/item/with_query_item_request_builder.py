...
if TYPE_CHECKING:
    from ...models.tfl27 import Tfl27
...
class WithQueryItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Search/{query}{?modes*,serviceTypes*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[WithQueryItemRequestBuilderGetQueryParameters]] = None) -> Optional[Tfl27]:
        """
        Search for lines or routes matching the query string
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[Tfl27]
        """
        ...
        return await self.request_adapter.send_async(request_info, Tfl27, None)
