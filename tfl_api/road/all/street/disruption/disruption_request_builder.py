...
class DisruptionRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Road/all/Street/Disruption
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Road/all/Street/Disruption?endDate={endDate}&startDate={startDate}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[DisruptionRequestBuilderGetQueryParameters]] = None) -> Optional[object]:
        """
