...
class StatusRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Line/Mode/{modes}/Status
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Line/Mode/{modes}/Status{?detail*,severityLevel*}", path_parameters)
