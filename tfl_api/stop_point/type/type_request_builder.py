...
class TypeRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /StopPoint/Type
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/StopPoint/Type", path_parameters)
    
    def by_types(self,types: str) -> WithTypesItemRequestBuilder:
        """
        Gets an item from the tfl_api.StopPoint.Type.item collection
