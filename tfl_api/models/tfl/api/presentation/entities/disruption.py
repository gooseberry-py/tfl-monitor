...
if TYPE_CHECKING:
    from .disrupted_route import DisruptedRoute
    from .disruption_category import Disruption_category
    from .stop_point import StopPoint

@dataclass
class Disruption(AdditionalDataHolder, Parsable):
    """
    ...
    affected_routes: Optional[list[DisruptedRoute]] = None
    # Gets or sets the stops affected by this disruption
    affected_stops: Optional[list[StopPoint]] = None
    # Gets or sets the category of this dispruption.
    category: Optional[Disruption_category] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Disruption:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "affectedRoutes": lambda n : setattr(self, 'affected_routes', n.get_collection_of_object_values(DisruptedRoute)),
            "affectedStops": lambda n : setattr(self, 'affected_stops', n.get_collection_of_object_values(StopPoint)),
            "category": lambda n : setattr(self, 'category', n.get_enum_value(Disruption_category)),
