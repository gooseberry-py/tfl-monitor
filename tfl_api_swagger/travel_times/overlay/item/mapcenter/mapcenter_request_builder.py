...
class MapcenterRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /TravelTimes/overlay/{z}/mapcenter
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/TravelTimes/overlay/{z}/mapcenter", path_parameters)
    
    def by_map_center_lat(self,map_center_lat: float) -> WithMapCenterLatItemRequestBuilder:
        """
        Gets an item from the tfl_api.TravelTimes.overlay.item.mapcenter.item collection
