...
class OverlayRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Place/{-id}/overlay
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Place/{%2Did}/overlay", path_parameters)
    
    def by_z(self,z: int) -> WithZItemRequestBuilder:
        """
        Gets an item from the tfl_api.Place.item.overlay.item collection
