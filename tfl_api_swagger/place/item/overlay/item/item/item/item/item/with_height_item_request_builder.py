...
class WithHeightItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Place/{-id}/overlay/{z}/{Lat}/{Lon}/{width}/{height}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Place/{%2Did}/overlay/{z}/{Lat}/{Lon}/{width}/{height}?lat={lat}&location.lat={location%2Elat}&location.lon={location%2Elon}&lon={lon}", path_parameters)
