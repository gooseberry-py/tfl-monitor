...
@dataclass
class Prediction(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Prediction:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "baseVersion": lambda n : setattr(self, 'base_version', n.get_str_value()),
            ...
            "tripId": lambda n : setattr(self, 'trip_id', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("baseVersion", self.base_version)
        ...
        writer.write_str_value("tripId", self.trip_id)
