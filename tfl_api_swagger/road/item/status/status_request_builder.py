...
class StatusRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Road/{ids}/Status
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Road/{ids}/Status{?dateRangeNullable%2EendDate*,dateRangeNullable%2EstartDate*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[StatusRequestBuilderGetQueryParameters]] = None) -> Optional[list[RoadCorridor]]:
        """
    ...
    class StatusRequestBuilderGetQueryParameters():
        ...
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "date_range_nullable_end_date":
                return "dateRangeNullable%2EendDate"
            if original_name == "date_range_nullable_start_date":
                return "dateRangeNullable%2EstartDate"
            return original_name
        
        date_range_nullable_end_date: Optional[datetime.datetime] = None

        date_range_nullable_start_date: Optional[datetime.datetime] = None
