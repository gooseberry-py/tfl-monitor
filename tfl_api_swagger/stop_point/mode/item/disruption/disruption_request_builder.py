...
class DisruptionRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /StopPoint/Mode/{modes}/Disruption
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/StopPoint/Mode/{modes}/Disruption{?includeRouteBlockedStops*}", path_parameters)
