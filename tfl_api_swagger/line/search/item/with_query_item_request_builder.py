...
if TYPE_CHECKING:
    from ....models.tfl.api.presentation.entities.route_search_response import RouteSearchResponse
...
class WithQueryItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Line/Search/{query}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Line/Search/{query}{?modes*,serviceTypes*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[WithQueryItemRequestBuilderGetQueryParameters]] = None) -> Optional[RouteSearchResponse]:
        """
        Search for lines or routes matching the query string
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[RouteSearchResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, RouteSearchResponse, None)
