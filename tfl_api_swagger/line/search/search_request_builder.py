...
class SearchRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Line/Search
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Line/Search", path_parameters)
    
    def by_query(self,query: str) -> WithQueryItemRequestBuilder:
        """
        Gets an item from the tfl_api.Line.Search.item collection
