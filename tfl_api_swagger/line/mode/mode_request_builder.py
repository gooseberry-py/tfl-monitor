...
class ModeRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Line/Mode
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Line/Mode", path_parameters)
    
    def by_modes(self,modes: str) -> WithModesItemRequestBuilder:
        """
        Gets an item from the tfl_api.Line.Mode.item collection
