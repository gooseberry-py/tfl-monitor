...
class StatusRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /Line/Status
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/Line/Status", path_parameters)
    
    def by_severity(self,severity: int) -> WithSeverityItemRequestBuilder:
        """
        Gets an item from the tfl_api.Line.Status.item collection
